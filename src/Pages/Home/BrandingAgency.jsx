...
import { SocialIconsData01, SocialIconsData02, SocialIconsData03, SocialIconsData04, SocialIconsData05, SocialIconsData06, SocialIconsData07, SocialIconsData11, SocialIconsData12 } from '../../Components/SocialIcon/SocialIconsData'
// Components"../
    ...
    return (
        <>
            ...
            <Header topSpace={{ md: true }} type="reverse-scroll">
                <HeaderNav fluid="fluid" theme="light" expand="lg" containerClass="px-0" className="py-[12px] px-[100px] mt-0 md:px-[15px] md:py-[20px] sm:px-0">
                    <Col className="col-5 col-lg-2 ps-lg-0 me-auto me-lg-0 ">
                        <Link aria-label="header logo" className="flex items-center" to="/">
                            <Navbar.Brand className="inline-block p-0 m-0">
                                <img className="default-logo" width="151" height="46" loading="lazy" src='/assets/img/webp/llogo.png' data-rjs='/assets/img/webp/llogo.png' alt='logo' />
                                <img className="alt-logo" width="151" height="46" loading="lazy" src='/assets/img/webp/llogo.png' data-rjs='/assets/img/webp/llogo.png' alt='logo' />
                                <img className="mobile-logo" width="151" height="46" loading="lazy" src='/assets/img/webp/llogo.png' data-rjs='/assets/img/webp/llogo.png' alt='logo' />
                            </Navbar.Brand>
                        </Link>
                    </Col>
            ...
            <div className="bg-white">
                ...
                <section className="h-[100vh] md:h-[700px] sm:h-[400px] relative bg-center bg-[#f3f3f3] overflow-hidden bg-cover flex justify-center items-end py-[130px]" style={{ backgroundImage: `url('/assets/img/webp/home-branding-agency-bg-img-03.webp')` }}>
                    ...
                    <m.span initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 4, duration: 1 }} className="text-xlg font-serif text-darkgray inline-block relative -tracking-[1px] leading-[25px] md:text-[17px] sm:text-lg xs:text-sm xs:absolute xs:bottom-[80px]">Redefining Branding ! We’re Your Presence Powerhouse</m.span>
                    ...
                    <Container fluid>
                        <Row>
                            <Col lg={2} md={4} className="flex flex-col justify-center border-r border-[#f5f5f5] p-0 sm:h-[400px]">
                                <m.div className="w-full content-box-image cover-background overflow-visible relative sm:h-full md:h-[300px] md:w-full" {...fadeIn} style={{ backgroundImage: "url(/assets/img/webp/pic1.jpg)" }}>
                                    <m.div className="justify-center items-center h-[130px] w-[130px] -right-[70px] -top-[70px] flex rounded-[50%] bg-white absolute box-shadow-extra-large sm:top-0 sm:right-0 md:w-[100px] md:h-[100px] md:-right-[50px] md:-top-[50px] xs:hidden" {...{ ...zoomIn, transition: { duration: 0.7, delay: 0.5 } }}>
                                        <h1 className="font-serif font-semibold text-darkgray mb-0 uppercase text-gradient bg-gradient-to-r from-[#b93c90] via-[#a92a96] to-[#951a9d]">L</h1>
                                    </m.div>
                                </m.div>
                            </Col>
                            <m.div className="flex flex-col justify-center border-b-[8px]  border-[#b93c90] xl:px-[5%] px-[8%] py-[12%] lg:py-[8%] lg:px-[7%] md:p-[10%] xs:border-0 col-xl-4 col-lg-6 col-md-8" {...{ ...fadeIn, transition: { delay: 0.4 } }}>
                                <span className="font-serif font-medium text-spanishgray uppercase block mb-[30px]">Our Approach</span>
                            ...
                            <Col lg={2} md={6} className="flex flex-col justify-center border-[1px] !border-t-0 !border-b-0 border-[#f5f5f5] p-0 sm:h-[400px] sm:border-0 md:h-[600px] md:justify-end">
                                <m.div className="content-box-image cover-background md:h-[300px] sm:h-full" style={{ backgroundImage: "url(/assets/img/webp/pic3.jpg)" }} {...fadeIn}></m.div>
                            </Col>
                            <Col lg={2} md={6} className="flex flex-col justify-start border-r border-[#f5f5f5] p-0 sm:h-[400px] md:h-[600px]">
                                <m.div className="content-box-image cover-background md:h-[300px] sm:h-full" style={{ backgroundImage: "url(/assets/img/webp/pic2.jpg)" }} {...{ ...fadeIn, transition: { delay: 0.5 } }}></m.div>
                            </Col>
                        </Row>
                    </Container>
                </section>
                    ...
                    <Container>
                        <Row className="justify-center">
                            <Col md={6} className="font-serif text-center mb-[5.5rem] lg:mb-24 sm:mb-20">
                                <span className="font-medium text-spanishgray uppercase block mb-[10px] tracking-[1px]">Our Ventures</span>
                                <h2 className="heading-4 font-semibold text-darkgray -tracking-[2px] mb-0">What We Do ?</h2>
                            </Col>
                    ...
                    <Container>
                        <Row className="justify-center items-center flex">
                            <m.div className="col-md-12 text-center" {...{ ...fadeIn, transition: { duration: 0.5, delay: 0.4 } }}>
                                <h2 className="heading-5 font-serif font-light mb-[20px] text-darkgray -tracking-[1px] md:mb-0">We help your Brand to</h2>
                                <TextAnime duration={3000} color="#232323" className="text-darkgray font-serif -tracking-[5px] text-center leading-[170px] text-[130px] font-semibold lg:text-[110px] lg:leading-[140px] md:text-[90px] md:leading-[110px] sm:text-[50px] sm:leading-[65px] sm:-tracking-[3px]" animation="slide" data={["Fabricate", "Navigate", "Elevate"]} />
                            </m.div>
                        </Row>
                    </Container>
                </section>
                ...
                <Container>
                    <Row className="justify-center">
                        <Col md={12} className="text-center mb-[7%]">
                            <h2 className="font-serif text-darkgray font-medium">Discover Our Mission</h2>
                        </Col>
                    </Row>
                    <Row className="justify-center">
          ...
          <Container>
            <Row className="justify-center items-center">
              <Col xl={5} lg={{ span: 6, order: 2 }} className="font-medium text-darkgray font-serif pb-[100px] ml-[97px] lg:ml-[0px] md:text-center md:pb-24">
                <span className="mb-[35px] text-lg -tracking-[.5px] inline-block relative whitespace-nowrap border-b border-solid border-darkgray md:text-xmd">At Legacies</span>
                <h4 className="-tracking-[1px] mb-[45px] xs:w-[99%]">Our Team drives impactful storytelling at Legacies.<span className="font-semibold"></span></h4>
      ...
      {/* Section end */}
      <m.div theme="light" topSpace={true} parallax={{ desktop: true, md: false }} className="bg-darkgray py-[10.5rem] md:py-[8.5rem]">
                <Container>
                    <Row className="flex justify-center">
                        <Col lg={8} className="text-center brandinga-agency-social-icon">
                            <SocialIcons theme="social-icon-style-08 justify-center" className="mb-[3.5rem] w-full" size="lg" iconColor="light" data={SocialIconsData08} />
                            ...
                            <h3 className="heading-4 font-serif font-semibold mb-28">
                                <a aria-label="gamil" href="mailto:info@domain.com" className="text-white text-decoration-line-bottom" target="_blank" rel="noreferrer">forum@legacies.app</a>
                            </h3>
                            <p className="mb-0 uppercase font-serif text-sm">© {new Date().getFullYear()} Legacies</p>
                        </Col>
                    </Row>
                </Container>
            </m.div>
